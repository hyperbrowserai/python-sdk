...
class JevComputerUseApiKeys(TypedDict, total=False):
    """Provider API keys for a Jev Computer Use task."""

    jev: Optional[str]
    google: Optional[str]


class StartJevComputerUseTaskParams(TypedDict, total=False):
    """Parameters for starting a Jev Computer Use task."""
