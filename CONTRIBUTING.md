...
- Preserve architectural guardrails with focused tests. Current guard suites include:
  ...
  - `tests/test_display_utils_import_boundary.py` (display utility module import boundary enforcement),
  ...
  - `tests/test_session_utils_import_boundary.py` (session helper import boundary enforcement),
