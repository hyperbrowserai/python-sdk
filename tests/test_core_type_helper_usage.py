...
CORE_MODULES = (
    ...
    "hyperbrowser/client/managers/computer_action_operation_metadata.py",
    ...
    "hyperbrowser/client/managers/extension_route_constants.py",
    "hyperbrowser/client/managers/extract_payload_utils.py",
    "hyperbrowser/client/managers/job_fetch_utils.py",
    "hyperbrowser/client/managers/job_operation_metadata.py",
